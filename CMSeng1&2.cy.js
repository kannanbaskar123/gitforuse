...
describe('CMS english 1', () => {
    it('should register successfully', () => {
        ...
        cy.xpath("(//h1[text()='CMS Electronics 1 on 1 - English'])[1]").click()
    ...
    it('should register successfully', () => {
        ...
        cy.xpath("(//h1[text()='CMS Electronics 1 on 1 - English'])[2]").click()

        cy.scrollTo(0, 600)
        cy.xpath("(//button/div[text()=' Book Now for ₹299 '])[2]").click()
